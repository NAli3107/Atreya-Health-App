...
const config = {
  ...
  initialMessages: [
    createChatBotMessage(
      "Hey there! Thank you for popping up today! Choose a topic to find out more about:",
      {
        ...
        options: [
          {
            ...
            url: "https://health.gov/our-work/nutrition-physical-activity/presidents-council#:~:text=Good%20nutrition%20is%20an%20important%20part%20of%20leading,disease%20and%20cancer%29%2C%20and%20promote%20your%20overall%20health.",
            id: 1,
          },
          {
      ...
      props: {
        options: [
          ...
          },
          {
            ...
            url: "https://www.mindful.org/how-do-i-bring-more-mindfulness-into-my-life/",
            id: 2,
          },
          {
        ...
        options: [
          {
            ...
            url: "https://www.reference.com/business-finance/safety-important-a3b361a3a5add64c",
            id: 1,
          },
          {
            text: "Be safe!",
            url: "https://www.wikihow.com/Be-Safe",
            id: 2,
          },
          {
