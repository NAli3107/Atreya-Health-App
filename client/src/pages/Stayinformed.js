...
const data = [
  ...
  },
  {
    ...
    title: "BODY",
    place:
      "https://www.arbonne.com/gb/en/arb/jeanmcleod/cart?shareId=8821428899367",
  ...
  return (
    <section id="portfolio">
      ...
      <div className="psign2">
        <p className="psign">
          {" "}
          Information is key, always seek professional advice if you have any
          medical/health questions, below are some resources you may find useful{" "}
        </p>
      </div>
                ...
                <div className="thumbnail">
                  <div key={id} className="beInformed_item">
                    ...
                    <div className="beInformed_item-cta">
                      <a href={place} className="btn" target="_blank">
                        Get help?
                      </a>
                      <a
                        href={demo}
